...
class ChartRenderer {
  ...
  getX(year) {
    return (
      this.margin.left +
      ((year - this.minYear) / (this.maxYear - this.minYear)) * this.chartWidth
    );
  }
...
/* =======================================================================
 *  DYNAMIC CHART CLASS - Add this to your existing app.js
 * =====================================================================*/
...
// /* =======================================================================
//  *  CHART INTEGRATION - Modify your existing render() function
//  * =====================================================================*/

// // Initialize chart renderer (add this line)
// let chartRenderer;

// // Add this to your existing DOMContentLoaded or initialization
// document.addEventListener("DOMContentLoaded", function () {
//   chartRenderer = new ChartRenderer("chart");
// });

// // In your existing render() function, add this line after updating the table:
// function render() {
...
//   // ADD THIS LINE to update chart
//   if (chartRenderer) {
//     chartRenderer.updateData(rows);
//   }
// }

// // Optional: Add year slider integration
// const yearSlider = $("yearsSliderRange");
// if (yearSlider) {
//   yearSlider.addEventListener("input", () => {
//     if (chartRenderer) {
//       chartRenderer.render(); // Re-render to update vertical line
//     }
//   });
// }
